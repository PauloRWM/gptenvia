...
export default function UpdatePasswordForm({ className }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Atualizar minha senha</h2>
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                ...
                <div>
                    <InputLabel htmlFor="password_confirmation" value="Repita a nova senha" />
